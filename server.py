...
def register():
    ...
    query = 'SELECT count(*) r FROM registration WHERE email = %(em)s'
    ...
    if not isValid:
        ...
        query = "INSERT INTO registration(first_name, last_name, email, passwordhash) VALUES (%(fn)s, %(ln)s, %(em)s, %(pwh)s);"
...
def login():
    ...
    query = 'SELECT * FROM registration WHERE email = %(em)s;'
